...
public interface EMFCompareConstants {
	...
	String PREFERENCES_DESCRIPTION_ENGINE_SELECTION = EMFCompareUIMessages
			.getString("EMFCompareConstants.preferences.engineSelectionLabel"); //$NON-NLS-1$

	/**
	 * Preferences description for the boolean indicating that the comparison should assume the compared
	 * models have distinct metamodels.
	 */
	...
	String PREFERENCES_KEY_DEFAULT_FILTERS = "emfcompare.default.filters";
}
